...
<html>
<head>
	<title>Hashed Form Example</title>
...
<div class="container-master">
	...
	<div class="container-account-creation-form">
		...
		<form action="hashedRegistration.php" method="get">
		...
		<?php
			...
			if(isset($_GET["email"]) && isset($_GET["password"])){
				...
				$insertUserQuery = "INSERT INTO userAccountsHashed (email, password, name) 
				...
				if(mysqli_error($DBConnectionDetails)){
					...
					echo "<a class=\"link-normal\" href=\"hashedUserLookup.php\">here</a> to confirm your information.</p>";
				}
			}
			else{
				echo "<div>";
