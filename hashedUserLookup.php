...
<div class="container-master">
	...
	<div class="container-account-creation-form">
		...
		<form action="hashedUserLookup.php" method="post">
	...
	<?php
		...
		if(!isset($_POST["email"])){}
			...
			//test' UNION ALL select CONCAT(email, ' -> ', password) as name FROM userAccountsHashed WHERE '1' = '1
			
			$getUserId = "SELECT name FROM userAccountsHashed WHERE email = '$email'";
